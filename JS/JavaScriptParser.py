...
def serializedATN():
    with StringIO() as buf:
        ...
        buf.write("\r\2\u008b\u0096\5\34\17\2\u008c\u0096\5\36\20\2\u008d")
        buf.write("\u0096\5 \21\2\u008e\u0096\5\"\22\2\u008f\u0096\5.\30")
...
class JavaScriptParser ( JavaScriptBaseParser ):
    ...
    def getter(self):
        ...
        try:
            ...
            if not this.p("get"):
                from antlr4.error.Errors import FailedPredicateException
                raise FailedPredicateException(self, "this.p(\"get\")")
            self.state = 766
            self.propertyName()
        except RecognitionException as re:
            localctx.exception = re
    ...
    def setter(self):
        ...
        try:
            ...
            if not this.p("set"):
                from antlr4.error.Errors import FailedPredicateException
                raise FailedPredicateException(self, "this.p(\"set\")")
            self.state = 770
            self.propertyName()
        except RecognitionException as re:
            localctx.exception = re
